...
/**
 * The 'actual' implementation of PlatformContext for Android.
 * It holds the required Android Context. We make it a data class.
 */
@Suppress("EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING")
actual data class PlatformContext(val androidContext: Context)
